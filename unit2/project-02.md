...
* A __new git repository hosted on Github__, where your codebase is maintained.
  - Most of the your work will be done on the __app.js__ file. You may update
  the index.html and style.css files if you would like to further customize your
  app.
* A 5-10 minute **presentation** including 3 technical hurdles, 2 new things you learned, Q&A. Your presentations can be done via recording on [Loom](https://www.loom.com/). 
...
the top right of [this](https://git.generalassemb.ly/jsr-1114/projects) page. Once
complete, clone the repository to your computer by running the following
commands:

```
cd ~/Sites/
git clone git@git.generalassemb.ly:jsr-1114/projects.git
cd unit2
```

You can then open VS Code and point it at the `~/Sites/unit2` directory and
